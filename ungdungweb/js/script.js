...
async function myFirstTfjs() {
    ...
    for (var i = 0; i < images.length; i++) {
        ...
        $("#result_info").append(`<li>${predictions_name[0].class_name}
...
function imageIsLoaded(e) {
    $('#imagesContainer').append('<img style="max-width:300px; max-height: 300px; border-radius:1rem" src=' + e.target.result + '>');
